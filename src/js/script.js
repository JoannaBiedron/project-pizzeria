...

{
  ...
  class AmountWidget{
    ...
    setValue(value){
      ...
      //TODO: Add validation
      if (newValue != settings.amountWidget.value && newValue >= settings.amountWidget.defaultMin && newValue <= settings.amountWidget.defaultMax){
  ...
  class Cart{
    ...
    getElements(element){
      ...
      thisCart.renderTotalsKeys = ['totalNumber', 'totalPrice', 'subtotlPrice', 'deliveryFee'];
